...
/**
 Get default camera zoom level.
 */
@property (readonly, nonatomic, assign) double defaultZoom;

#pragma mark Custom Local Resource Directory

- (void)setLocalResourceCacheDir:(NSString *)localResourceCacheDir;
